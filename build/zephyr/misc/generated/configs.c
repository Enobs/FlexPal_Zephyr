...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_SIZE, 3072);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_AIR_VALVE_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_GD_GD32_NV_FLASH_V3_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_GD_GD32_PINCTRL_AF_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_GD_GD32_SYSCFG_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_US6330_015_S_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GD32_HAS_AF_PINMUX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HAS_GD32_HAL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GD32_HXTAL_FIRMWARE_DEFINED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GD32_HAS_IRC_32K, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GD32_LOW_SPEED_IRC_FREQUENCY, 32000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_GD32F407V_START, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_SERIES_GD32F4XX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CPU_HAS_ARM_MPU, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_FAMILY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_FAMILY_GD32, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_FAMILY_GD32_ARM, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_GD32F407, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SRAM_SIZE, 112);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PINCTRL_GD32_AF, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PWM_GD32, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_TAG_MAX_LEN, 8);
